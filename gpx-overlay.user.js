...
(function () {
  ...
  function computeSeasonStats() {
    ...
    tracks.forEach(t => {
      ...
      if (!season) return;
      if (!seasons[season]) seasons[season] = { trips: 0, elevGain: 0, distance: 0, movingTimeMs: 0 };
  ...
  function updateTrackList() {
    ...
    seasonKeys.forEach(season => {
      ...
      header.onclick = () => {
        if (collapsedSeasons.has(season)) collapsedSeasons.delete(season);
        else collapsedSeasons.add(season);
        updateTrackList();
      };
